...
///     tokio_uring_xitca::fs::create_dir_all("/some/dir").await.unwrap();
/// });
/// ```
...
impl DirBuilder {
    ...
    ///
    /// ```
    /// let builder = tokio_uring_xitca::fs::DirBuilder::new();
    /// ```
    #[must_use]
    ...
    ///
    /// ```
    /// let mut builder = tokio_uring_xitca::fs::DirBuilder::new();
    ...
    ///     tokio_uring_xitca::fs::DirBuilder::new()
    ///         .recursive(true)

...
///
/// ```
/// use tokio_uring_xitca::net::TcpListener;
/// use tokio_uring_xitca::net::TcpStream;
///
...
impl TcpListener {
    ...
    ///
    ///     let listener = tokio_uring_xitca::net::TcpListener::from_std(listener.into_std().unwrap());
    /// })
    /// ```
    ...
    pub async fn accept(&self) -> io::Result<(TcpStream, SocketAddr)> {
        ...
        let socket_addr = socket_addr.ok_or_else(|| io::Error::other("Could not get socket IP address"))?;

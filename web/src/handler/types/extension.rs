...
use crate::{handler::Extract, http::Extensions, request::WebRequest};
...
impl<'a, 'r, S: 'r, T> Extract<'a, WebRequest<'r, S>> for ExtensionRef<'a, T>
where
    T: Send + Sync + 'static,
{
...
impl<'a, 'r, S: 'r> Extract<'a, WebRequest<'r, S>> for ExtensionsRef<'a> {

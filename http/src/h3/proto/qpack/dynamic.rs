...
mod tests {
    ...
    use super::super::{static_::StaticTable, tests::helpers::build_table};
    use super::*;
    ...
    fn test_eviction_is_fifo() {
        ...
        assert_eq!(table.fields.front(), Some(&HeaderField::new("Name-B", "Value-B")));
